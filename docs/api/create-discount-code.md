            ...
            properties:
              ...
              code:
                allOf:
                  - type: string
                    description: >-
                      Optional discount code. If left empty, a code will be
                      generated.
                    example: HOLIDAY2024
              type:
                allOf:
              ...
              amount:
                allOf:
                  - type: number
                    description: >-
                      The fixed value for the discount. Only applicable if the
                      type is "fixed".
                    example: 20
              currency:
                allOf:
              ...
              percentage:
                allOf:
                  - type: number
                    description: >-
                      The percentage value for the discount. Only applicable if
                ...
                allOf:
                  - description: The list of product IDs to which this discount applies.
                    ...
                    items:
                      type: string
            required: true
            refIdentifier: '#/components/schemas/CreateDiscountRequestEntity'
            requiredProperties:
              - name
              - type
              - duration
